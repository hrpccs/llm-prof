...
// target_pid restricts on-CPU sampling to a single process (0 = all).
// llm-prof: keeps the ringbuffer from being flooded by other processes.
BPF_RODATA_VAR(u32, target_pid, 0)
